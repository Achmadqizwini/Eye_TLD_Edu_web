...
import AnimatedSection from '../common/AnimatedSection';
import { Brain, ExternalLink, ClipboardList } from 'lucide-react';

const GOOGLE_FORM_URL =
  'https://docs.google.com/forms/d/e/1FAIpQLScXawoduZKq4bUp7avfop59nbRsqwrP2GoYb4YEQndjdNaagw/viewform?embedded=true';

const GOOGLE_FORM_EXTERNAL_URL =
  'https://docs.google.com/forms/d/e/1FAIpQLScXawoduZKq4bUp7avfop59nbRsqwrP2GoYb4YEQndjdNaagw/viewform?usp=publish-editor';
          ...
          <div className="glass-card overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-purple-500 to-pink-500 px-6 py-4 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-white font-semibold">Kuis Proteksi Radiasi Lensa Mata</span>
              </div>
              ...
              <motion.a
                ...
                className="inline-flex items-center space-x-1.5 bg-white/20 hover:bg-white/30 text-white text-xs font-medium px-3 py-1.5 rounded-full transition-colors"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
            ...
            {/* Iframe Container */}
            <div className="relative w-full bg-gray-50" style={{ minHeight: '680px' }}>

              {/* Loading skeleton */}
              {!iframeLoaded && (
                <div className="absolute inset-0 flex flex-col items-center justify-center space-y-4 z-10 bg-gray-50">
                  <div className="w-10 h-10 border-4 border-purple-200 border-t-purple-500 rounded-full animate-spin" />
                  <p className="text-sm text-gray-400">Memuat kuis...</p>
                </div>
              )}

              <iframe
                src={GOOGLE_FORM_URL}
                title="Kuis Proteksi Radiasi Lensa Mata"
                width="100%"
                height="680"
                frameBorder="0"
                marginHeight="0"
            ...
            {/* Card Footer */}
            <div className="px-6 py-4 bg-purple-50 border-t border-purple-100 flex items-center justify-between flex-wrap gap-3">
              <p className="text-xs text-gray-500">
                📋 Jawaban Anda akan tersimpan secara otomatis oleh Google Forms.
              </p>
              <motion.a
                href={GOOGLE_FORM_EXTERNAL_URL}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center space-x-2 text-xs font-semibold text-purple-600 hover:text-pink-500 transition-colors"
                whileHover={{ x: 3 }}
              >
                <span>Kesulitan melihat form?</span>
                <ExternalLink className="w-3 h-3" />
              </motion.a>
            </div>
